...
(function ($) {
  ...
  var _animate = $.fn.animate,
    ...
    autoCSS: 1
      ...
      _copyCriticalReserved = function _copyCriticalReserved(main, sub) {
    for (var p in _reserved) {
      ...
      _createEase = function _createEase(ease) {
    return function (p) {
      return ease.getRatio(p);
    };
  },
      _easeMap = {},
      _init2 = function _init() {
  ...
  $.fn.animate = function (prop, speed, easing, callback) {
    ...
    if (!_enabled || prop.skipGSAP === true || _typeof(speed) === "object" && typeof speed.step === "function") {
    ...
    var config = $.speed(speed, easing, callback),
      ...
      ease: _easeMap[config.easing] || (config.easing === false ? _easeMap.linear : _easeMap.swing)
        ...
        obj = this,
        specEasing = _typeof(speed) === "object" ? speed.specialEasing : null,
        val,
        p,
        doAnimation,
        specEasingVars;
    ...
    for (p in prop) {
      ...
      if (val === "show" || val === "hide" || val === "toggle" || _legacyProps.indexOf(p) !== -1 && _legacyProps.indexOf("," + p + ",") !== -1) {
    ...
    doAnimation = function doAnimation(next) {
  ...
  $.gsap = {
    ...
    version: "0.1.13",
    legacyProps: function legacyProps(value) {
      _legacyProps = _defaultLegacyProps + value + ",";
    }
  };
})(jQuery);
//# sourceMappingURL=jquery.gsap.js.map
