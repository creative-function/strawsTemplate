...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine("GSDevTools", ["TweenLite", "core.Animation", "core.SimpleTimeline", "TimelineLite", "utils.Draggable", "plugins.CSSPlugin"], function (TweenLite, Animation, SimpleTimeline, TimelineLite, Draggable) {
    ...
    _merge = function _merge() {
      ...
      }).to(svg.querySelector(".play-2"), 0.5, {
        attr: {
      ...
      tl.to(svg, 0.5, {
        ...
        ease: Power3.easeInOut,
        transformOrigin: "50% 50%"
      }).to(svg.querySelectorAll(".loop-path"), 0.5, {
        fill: "#91e600",
        ease: Linear.easeNone
      }, 0);
      return tl;
    ...
    _recordedRoot._startTime = _recordedTemp._startTime = _globalTimeline._time = _globalTimeline._totalTime = 0; //in case GSDevTools.create() is called before anything is actually on the global timeline, we've gotta update it or else the duration will be 0 and it'll be stuck.
    ...
    _globalTimeline.add = function (child, position, align, stagger) {
      var data = child.data; //TODO: idea: what if we ignore any zero-duration tweens that occur in the first second or two, and then lock the "global timeline" down after that anyway? Perhaps offer a way to update() manually?

      if (_recording && child.vars && data !== "root" && data !== "ignore" && data !== "isStart" && data !== "isFromStart" && data !== "_draggable" && !(_startupPhase && !child._duration && child instanceof TweenLite) && !(child.vars.onComplete && child.vars.onComplete === child.vars.onReverseComplete)) {
        ...
        tl.add(child, position, align, stagger); //TODO: what if timeScale is set initially low, and a delayedCall() fires another animation?? It'd fire early.
  ...
  _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function (EventDispatcher, TweenLite, CSSPlugin) {
    ...
    _point2 = {},
      ...
      return !!(_SVGElement && typeof e.getBBox === "function" && e.getCTM && (!e.parentNode || e.parentNode.getBBox && e.parentNode.getCTM));
        ...
        _isIE10orBelow = _gsScope.navigator && (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(_gsScope.navigator.userAgent) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(_gsScope.navigator.userAgent)) && parseFloat(RegExp.$1) < 11,
...
//# sourceMappingURL=GSDevTools.js.map
