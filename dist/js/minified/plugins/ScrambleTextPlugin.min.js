...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = /(^\s+|\s+$)/g,
    ...
    return d;
      ...
      e = function e(a) {
    this.chars = i(a), this.sets = [], this.length = 50;
    var b;

    for (b = 0; 20 > b; b++) {
      this.sets[b] = d(80, this.chars);
    }

    this.grow = function (a) {
      for (b = 0; 20 > b; b++) {
        this.sets[b] += d(a - this.length, this.chars);
      }
      ...
      h = new RegExp(f + "|.", "g"),
      i = function i(b, c, d) {
    return d && (b = b.replace(a, "")), "" !== c && c || !g.test(b) ? b.split(c || "") : b.match(h);
  },
    ...
    init: function init(a, d, f, h) {
      if (this._prop = "innerHTML" in a ? "innerHTML" : "textContent" in a ? "textContent" : 0, !this._prop) return !1;
      "function" == typeof d && (d = d(h, a)), this._target = a, "object" != _typeof(d) && (d = {
        text: d
      });
      var j,
          k,
